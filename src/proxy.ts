...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|images/|videos/|favicon.ico|icon-192.png|icon-512.png|icon-maskable-512.png|apple-touch-icon.png|manifest.webmanifest|sw.js|offline.html).*)",
  ],
};
